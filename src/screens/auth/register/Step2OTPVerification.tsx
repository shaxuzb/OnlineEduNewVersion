...
const Step2OTPVerification: React.FC = () => {
  const { registerData, otpData, setOtpData, nextStep, prevStep } = useRegister();
      ...
      >
        <View style={styles.content}>
          ...
          <TouchableOpacity
            style={[
              styles.verifyButton,
              (isVerifying || otpCode.join('').length !== 6) && styles.verifyButtonDisabled
            ]}
          ...
          <View style={styles.buttonsRow}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                Alert.alert(
                  'OTP ni o\'tkazib yuborish',
                  'Haqiqiy ilovada bu imkonsiz, lekin demo uchun o\'tkazib yuborishingiz mumkin.',
                  [
                    { text: 'Bekor qilish', style: 'cancel' },
                    { text: 'O\'tkazib yuborish', onPress: nextStep, style: 'destructive' }
                  ]
                );
              }}
            >
